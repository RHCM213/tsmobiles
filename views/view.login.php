...
?>
        ...
        <div class="w3-row" style="width:60%; margin:auto"> 
            ...
            <form method="post" action="/login" style="margin-top:40px">
                ...
                <div class="w3-center">
                    <button class="w3-text-brown w3-sand w3-button w3-round-large w3-hover-dark-grey" type="submit" name="send" style="margin-top:50px">Entrar</button>
                </div>         
            </form>
        </div>
